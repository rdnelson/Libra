...
QMAKE    = /usr/bin/qmake
libra-qt.xcodeproj/project.pbxproj: ../src/libra-qt.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.8/mkspecs/macx-xcode -o libra-qt.xcodeproj/project.pbxproj libra-qt.pro
